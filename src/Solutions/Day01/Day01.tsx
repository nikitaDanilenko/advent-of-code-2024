...
import solutionFrom, { Pair, Solution } from '../Utils/Types.ts'
...
export function parse(puzzleInput: string): PuzzleInput {
...
export const solve: (puzzleInput: PuzzleInput) => Solution<bigint> =
